...
class ImVoiceWidget extends StatefulWidget {
  final Function startRecord;
  final Function stopRecord;

  /// startRecord 开始录制回调  stopRecord回调
  const ImVoiceWidget({Key key, this.startRecord, this.stopRecord})
      : super(key: key);
...
class _VoiceWidgetState extends State<ImVoiceWidget> {
  double starty = 0.0;
  double offset = 0.0;
  bool isUp = false;
